...
- **Debugging**: Serial output (115200 baud) is enabled in both Operation and Dev modes. Dev Mode provides a comprehensive, single-line summary of all sensor readings, including a human-readable UTC timestamp.
